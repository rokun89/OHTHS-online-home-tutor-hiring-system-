    ...
    <div class="row">
        <div class="col-md-4">
              ...
              <div class="caption">
                  ...
                  <input value="{{$tutordetails->tutor->name}}"></p>

                  <p> <label for="Name">Subject:</label>
                  <input value="{{$tutordetails->subject->name}}"></p>

                  <p> <label for="Name">Salary:</label>
                  <input value="{{$tutordetails->salary}}"></p>

                  <p> <label for="Name">Weekend-Days:</label>
                  <input value="{{$tutordetails->weekend_days}}"></p>

                  <p> <label for="Name">Title:</label>
                  <input value="{{$tutordetails->title}}"></p>
